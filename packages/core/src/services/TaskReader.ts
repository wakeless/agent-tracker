...
import { Task, TaskSet, TaskSummary, TaskStatus } from '../types/task.js';
...
export class TaskReader {
   ...
   */
  private getTaskSummary(conversationId: string, conversationDir: string): TaskSummary | null {
   ...
   */
  private readTasksFromDir(conversationDir: string): Task[] {
    const tasks: Task[] = [];
