    ...
    return (React.createElement(Box, { flexDirection: "column", padding: 2 },
        ...
        React.createElement(Box, { marginBottom: 1, flexDirection: "column" },
            ...
            React.createElement(Box, { marginTop: 1, marginLeft: 2, flexDirection: "column" },
                React.createElement(Text, null, "1. Add the plugin marketplace (in a Claude Code session or terminal):"),
                React.createElement(Box, { marginLeft: 3, marginTop: 0, marginBottom: 1, flexDirection: "column" },
                    React.createElement(Text, { color: "yellow" }, "/plugin marketplace add wakeless/agent-tracker"),
                    React.createElement(Text, { dimColor: true }, "or: claude plugin marketplace add wakeless/agent-tracker")),
                ...
                React.createElement(Box, { marginLeft: 3, marginTop: 0, marginBottom: 1, flexDirection: "column" },
                    ...
                    React.createElement(Text, { dimColor: true }, "or: claude plugin install agent-tracker")),
